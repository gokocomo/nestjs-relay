...
exports.GlobalIdScalar = class GlobalIdScalar {
    ...
    serialize(value) {
        ...
        const { id, type } = value;
        if (!id || !type) {
            throw new graphql$1.GraphQLError(`Invalid ID value: ${value}`);
        }
        return graphqlRelay.toGlobalId(type, id);
    }
    parseLiteral(ast) {
...
const isPromise = (maybePromise) => Boolean(typeof (maybePromise === null || maybePromise === void 0 ? void 0 : maybePromise.then) === 'function');
